...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-a396cf7756922e69"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-a396cf7756922e69",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-a396cf7756922e69",
        "url": "https://en.wikipedia.org/wiki/B%C3%BCchi%27s_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Büchi's problem on sufficiently large sequences of square numbers with constant second difference.",
      "version": 1
    },
    "title": "Büchi's problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "d93527e5122645f7974ad41f4b9ba3c1c781b7751e2ae964aeaeac16a795648d"
}
```
